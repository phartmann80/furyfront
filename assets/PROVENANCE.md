...
| Play start background | `assets/play-start-background.jpg` | Godot `/play/` start still, authored 1920×1080 from `assets/rear_over_elite_squad.webp`. Runtime copy: `game/assets/ui/start_background.jpg`. Live Godot Controls own title, quality, and Start. |
