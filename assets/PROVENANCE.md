...
| Play start background | `assets/play-start-background.png` | Godot `/play/` start menu still. Runtime copy: `game/assets/ui/start_background.png`. Live Godot Controls own title, quality, and Start — do not rely on pixels in the still. |
